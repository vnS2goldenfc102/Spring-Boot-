...
//    SinhVienEntity getByStudentCode(Integer student_code);
    ...
    SinhVienEntity getByStudentCode(Integer student_code);
    @Modifying
    @Query(value = "INSERT INTO sinh_vien(student_code, name, age, id_lop) VALUES (:student_code, :name, :age, :id_lop)",nativeQuery = true)
    @Transactional
    void createStudent(@Param("student_code") Integer student_code, @Param("name") String name, @Param("age") Integer age, @Param("id_lop") Integer id_lop);

    @Modifying
    @Query(value = "UPDATE sinh_vien SET student_code =:student_code, name =:name, age = :age, id_lop = :id_lop WHERE sinh_vien.id = :id", nativeQuery = true)
    @Transactional
    void updateStudent(@Param("student_code") Integer student_code, @Param("name") String name, @Param("age") Integer age, @Param("id_lop") Integer id_lop, @Param("id") Integer id);
